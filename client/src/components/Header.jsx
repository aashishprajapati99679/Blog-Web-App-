    ...
    return (
        <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
            <div className='text-center mt-20 mb-8'>
                ...
                <form onSubmit={onSubmitHandler} className='flex justify-between max-w-lg max-sm:scale-75 mx-auto bg-white  border rounded-full border-gray-300 rounded overflow-hidden'>
                    <input
                        ref={inputRef}
                        type="text"
